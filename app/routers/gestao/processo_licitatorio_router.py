...
from app.schemas.planejamento.processo_licitatorio_schema import ProcessoLicitatorioRequest, ProcessoLicitatorioResponse 
...
router = APIRouter(
    ...
    tags=["Gestão - Processos Licitatórios"], 
